        ...
        <>
            ...
            <section className="columns">
                ...
                <article className="column content m-5">
                    <h3>How</h3>
                    <p>What's for Dinner Poker is easy to learn! Navigate to play, choose a deck, and draw. The deck is shuffled and you are dealt five dinner cards. Use the hold buttons to keep a card in your hand through the next draw. See something you'd like to eat this week? Hold it!<br /> You will have three rounds to make your final hand. The final five cards at the end of the game make up your meal plan! 🎊 <br />Copy the results to your clipboard, save them to your game history list, or just keep playing!</p>
                    <h3>About</h3>
